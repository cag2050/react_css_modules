        ...
        return (
            <Layout style={{height: '100%'}}>
                ...
                <Layout style={{background: 'white'}}>
                    <Header style={{background: 'yellow', paddingLeft: '20px', position: 'fixed', 'zIndex': '1', width: '100%'}}>
                        <Icon
                            style={{
                                float: 'left',
                                position: 'relative',
                        ...
                        <Button onClick={this.logout}
                                style={{float: 'right', top: '15px', position: 'relative', right: '160px'}}>退出</Button>
                    </Header>
                    <Content style={{margin: '75px 10px 10px 10px', padding: 10, background: '#fff', minHeight: 280}}>
                        <Switch>
